...
<p style="text-align: left; margin-top: 1.5rem;">These are formatted as pdf slideshows in full screen. The file sizes are large, ~4-5MB, so you may have trouble downloading if your internet connection is slow. Converting these works to slide shows designed for casual web browsing has been on my to-do list for years but time has not been on my side. <em>Bon voyage</em></p>

</div>

<div style="flex: 0 0 33%; display: flex; flex-direction: column; gap: 1.5rem;">

<img src="/images/explorations/Cam-stamp.jpg" alt="Cameroun stamp" style="width: 100%;">

<img src="/images/explorations/SL-bank-note.png" alt="Sierra Leone" style="width: 100%;">
